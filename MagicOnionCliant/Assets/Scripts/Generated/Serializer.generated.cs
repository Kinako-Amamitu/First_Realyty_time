...
namespace MessagePack.Formatters.MasicOnionServer00.Model.Entity
{
    public sealed class UserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::MasicOnionServer00.Model.Entity.User>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::MasicOnionServer00.Model.Entity.User value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::MasicOnionServer00.Model.Entity.User Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::MasicOnionServer00.Model.Entity.User();
...
namespace MessagePack.Formatters.Shared.Interfaces.StreamingHubs
{
    public sealed class JoinedUserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Interfaces.StreamingHubs.JoinedUser>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Interfaces.StreamingHubs.JoinedUser value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::MasicOnionServer00.Model.Entity.User>(formatterResolver).Serialize(ref writer, value.UserData, options);
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        ____result.UserData = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::MasicOnionServer00.Model.Entity.User>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 2:
                        ____result.JoinOrder = reader.ReadInt32();
                        break;
                    case 3:
                        ____result.IsMaster = reader.ReadBoolean();
                        break;
                    default:
                        reader.Skip();
                        break;
